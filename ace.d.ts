...
declare module "ace-code/src/virtual_renderer" {
    ...
    export interface VirtualRenderer extends Ace
        .EventEmitter<Ace.VirtualRendererEvents>, Ace.OptionsProvider<Ace.VirtualRendererOptions> {
        textarea?: HTMLTextAreaElement;
        enableKeyboardAccessibility?: boolean;
        keyboardFocusClassName?: string;
        showInvisibles?: boolean;
...
declare module "ace-code/src/edit_session" {
    ...
    export interface EditSession extends Ace.
        EventEmitter<Ace.EditSessionEvents>, Ace.OptionsProvider<Ace.EditSessionOptions>, Ace.Folding, Ace.
        BracketMatch {
        doc: Ace.Document;
        widgetManager?: any;
        curOp?: {
...
declare module "ace-code/src/ext/prompt" {
    ...
    export namespace prompt {
         ...
         * @param {Function} [callback]
         */
        function modes(editor: import("ace-code/src/editor").Editor, callback?: Function): void;
    }
}
...
declare module "ace-code/src/ext/textarea" {
    const _exports: {
        ...
        createEditSession: (text: string | import("ace-code/src/document").Document, mode?: import("ace-code").Ace.SyntaxMode) => ace.EditSession;
