...
module.exports = {
    ...
    "test: find simple text in document" : function() {
        var session = new Buffer(["juhu kinners 123", "456"]);
    ...
    "test: find simple text in next line" : function() {
        var session = new Buffer(["abc", "juhu kinners 123", "456"]);
        var search = new Search().set({
            needle: "kinners"
        });
    ...
    "test: find text starting at cursor position" : function() {
        var session = new Buffer(["juhu kinners", "juhu kinners 123"]);
    ...
    "test: whole word search should not match inside of words": function() {
        var session = new Buffer(["juhukinners", "juhu kinners 123", "456"]);
    ...
    "test: find backwards": function() {
        var session = new Buffer(["juhu juhu juhu juhu"]);
    ...
    "test: edge case - match directly before the cursor" : function() {
        var session = new Buffer(["123", "123", "juhu"]);
    ...
    "test: find using a regular expression" : function() {
        var session = new Buffer(["abc123 123 cd", "abc"]);
    ...
    "test: use regular expressions with capture groups": function() {
        var session = new Buffer(["  ab: 12px", "  <h1 abc"]);
    ...
    "test: find all matches in a line" : function() {
        var session = new Buffer("foo bar foo baz foobar foo");
