...
isAce || testSubstitute('ex_substitute_dollar_assertion', {
  value: 'one,two \n three,four',
  expectedValue: 'one,two ,\n three,four', // TODO: should match at end of doc.
  expr: '%s/$/,/g'});
isAce || testSubstitute('ex_substitute_dollar_literal', {
  value: 'one$two\n$three\nfour$\n$',
  expectedValue: 'one,two\n,three\nfour,\n,',
  expr: '%s/\\$/,/g'});
isAce || testSubstitute('ex_substitute_newline_match', {
  ...
  expr: '%s/\\n/,/g'});
isAce || testSubstitute('ex_substitute_newline_join_global', {
  value: 'one,two \n three,four \n five \n six',
  expectedValue: 'one,two \n three,four , five \n six',
  expr: '2s/\\n/,/g'});
isAce || testSubstitute('ex_substitute_newline_join_noglobal', {
  value: 'one,two \n three,four \n five \n six\n',
  expectedValue: 'one,two \n three,four , five , six\n',
  expr: '2,3s/\\n/,/'});
