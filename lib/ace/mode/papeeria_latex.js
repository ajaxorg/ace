...
(function() {
    ...
    var myDocumentCommentsCallbacks = {
        onSuccess: null
    };
    ...
    this.createWorker = function(session) {
        ...
        worker.on("getComments", function(comments) {
            if (myDocumentCommentsCallbacks.onSuccess != null) {
                myDocumentCommentsCallbacks.onSuccess(comments);
            }
        });
        ...
        session.on("setGetCommentsCallback", function(data) {
            myDocumentCommentsCallbacks = {
