...
(function() {
    ...
    this.createWorker = function(session) {
        ...
        worker.on("settingsUpdateSuccess", function(result) {
            if (typeof mySettingsUpdateCallbacks.onSuccess !== "undefined" && mySettingsUpdateCallbacks.onSuccess !== null) {
                mySettingsUpdateCallbacks.onSuccess();
            }
        });

        worker.on("settingsUpdateError", function(result) {
            if (typeof mySettingsUpdateCallbacks.onError !== "undefined" && mySettingsUpdateCallbacks.onError !== null) {
