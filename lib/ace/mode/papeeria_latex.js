...
var Mode = function() {
    ...
    myOnNewDictionaryCallback = null;
};
...
(function() {
    ...
    this.createWorker = function(session) {
        ...
        worker.on("newDictionary", function(result) {
            if (typeof myOnNewDictionaryCallback !== "undefined" && myOnNewDictionaryCallback !== null) {
                myOnNewDictionaryCallback();
            }
        });
        ...
        session.on("changeSpellingCheckSettings", function(data) {
            ...
            myOnNewDictionaryCallback = data.onNewDictionary;
        });
