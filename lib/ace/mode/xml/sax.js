        ...
        switch (source.charAt(i + 1)) {
            ...
            default:
                try {
                    ...
                    //elStartEnd
                    var end = parseElementStartPart(source, i, el, entityReplacer, errorHandler, locator && position);
                    var len = el.length;
                    //position fixed
                    if (len && locator) {
 ...
 */
function parseElementStartPart(source, start, el, entityReplacer, errorHandler, position) {
    var attrName;
    var value;
    var p = ++start;
    var s = S_TAG; //status
