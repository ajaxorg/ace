    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            callback({
                ...
                status: +((xhr.status >= 200 && xhr.status < 300) || xhr.status == 0)
            });
        }
    };
    xhr.send(null);
...
(function() {
    ...
    this.$setDictionary = function(lang) {
        var _url = "/demo/typojs/dictionaries/" + lang + "/" + lang;
    ...
    this.setOptions = function(options) {
        ...
        if (this.options.lang) {            
            this.$setDictionary(this.options.lang);
        }
        this.doc.getValue() && this.deferredUpdate.schedule(20);
    };

    this.changeOptions = function(newOptions) {
        var toSetNewDictionary = newOptions.lang != this.options.lang;
