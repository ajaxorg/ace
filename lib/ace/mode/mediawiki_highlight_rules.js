...
var MediaWikiHighlightRules = function() {
    this.$rules = {
        ...
        "#switch": [{
            token: [
                "constant.language",
                "constant.language.mediawiki",
                "constant.language"
            ],
            regex: /(__)(NOTOC|FORCETOC|TOC|NOEDITSECTION|NEWSECTIONLINK|NONEWSECTIONLINK|NOWYSIWYG|NOGALLERY|HIDDENCAT|EXPECTUNUSEDCATEGORY|NOCONTENTCONVERT|NOCC|NOTITLECONVERT|NOTC|START|END|INDEX|NOINDEX|STATICREDIRECT|NOGLOBAL|DISAMBIG)(__)/
        }],
        "#variable": [{
