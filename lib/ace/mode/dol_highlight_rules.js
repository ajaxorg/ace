...
"use strict";
		...
		this.$rules = {
		    'start': [
              //OwlHighlightRules.getStartRule("owl-start"),
                ...
                {
                    token: externalKeywords ,
                    regex: "[0-9a-zA-Z:-{}]+",
                    onMatch: function (input, state, stack) {
                        ///////////////////////////////////////////////////////////////////////
                        // the highlighting for one mode is possible throgh the inheriting of that mode inside the dolMode 
                        ///////////////////////////////////////////////////////////////////////
                        // i guess the problem is with the embed rules i am not using it right.
                        ///////////////////////////////////////////////////////////////////////
	   ...
	   //     this.$rules[key].unshift.apply(this.$rules[key], this.$rules.start);

	   // this.embedRules(OwlHighlightRules, "owl-", endRules, ["start"]);
		    
	
		this.normalizeRules();
		};
  
		oop.inherits(DolHighlightRules, OwlHighlightRules);
