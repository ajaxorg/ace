// $ANTLR 3.3 Nov 30, 2010 12:50:56 XMLLexer.g 2012-04-03 22:00:06
...
var XMLLexer = exports.XMLLexer = function(input, state) {
...
org.antlr.lang.extend(XMLLexer, XQDTLexer, {
    ...
    NCNameUnprotected : 283,
    XMLDigit : 284,
    getGrammarFileName: function() { return "XMLLexer.g"; }
});
org.antlr.lang.augmentObject(XMLLexer.prototype, {
    ...
    mL_NCName: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:135:2: ({...}? => NCNameUnprotected )
            // XMLLexer.g:135:4: {...}? => NCNameUnprotected
            if ( !(( this.inElem )) ) {
    ...
    mNCNameUnprotected: function()  {
        try {
            // XMLLexer.g:139:2: ( NCNameStartChar ( NCNameChar )* )
            // XMLLexer.g:139:4: NCNameStartChar ( NCNameChar )*
            this.mNCNameStartChar(); 
            // XMLLexer.g:139:20: ( NCNameChar )*
            loop5:
            do {
                var alt5=2;
    ...
    mNCNameChar: function()  {
        try {
            // XMLLexer.g:147:2: ( Letter | XMLDigit | '.' | '-' | '_' )
            // XMLLexer.g:
    ...
    mXMLDigit: function()  {
        try {
            // XMLLexer.g:155:2: ( '0' .. '9' )
            // XMLLexer.g:155:4: '0' .. '9'
            this.matchRange('0','9'); 
    ...
    mCDATA_START: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:187:13: ( '<![CDATA[' )
            // XMLLexer.g:187:15: '<![CDATA['
            this.match("<![CDATA["); 
    ...
    mL_CDataSection: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:192:3: ({...}? => CDATA_START ( options {greedy=false; } : ( . )* ) CDATA_END )
            // XMLLexer.g:192:5: {...}? => CDATA_START ( options {greedy=false; } : ( . )* ) CDATA_END
            if ( !(( !this.inElem )) ) {
                throw new org.antlr.runtime.FailedPredicateException(this.input, "L_CDataSection", " !this.inElem ");
            }
            this.mCDATA_START(); 
            // XMLLexer.g:192:38: ( options {greedy=false; } : ( . )* )
            // XMLLexer.g:192:65: ( . )*
            // XMLLexer.g:192:65: ( . )*
            loop6:
            do {
    ...
    mL_PredefinedEntityRef: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:200:2: ({...}? => '&' ( 'lt' | 'gt' | 'apos' | 'quot' | 'amp' ) ';' )
            // XMLLexer.g:200:4: {...}? => '&' ( 'lt' | 'gt' | 'apos' | 'quot' | 'amp' ) ';'
            if ( !(( !this.inElem || this.inAposAttr || this.inQuotAttr )) ) {
            ...
            this.match('&'); 
            // XMLLexer.g:200:67: ( 'lt' | 'gt' | 'apos' | 'quot' | 'amp' )
            var alt7=5;
    ...
    mL_CharRef: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:205:2: ({...}? => '&#' ( '0' .. '9' )+ ';' | '&#x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ ';' )
            var alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // XMLLexer.g:205:86: '&#x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ ';'
                    this.match("&#x"); 

                    // XMLLexer.g:205:92: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
                    var cnt9=0;
                    loop9:
                    do {
                        var alt9=2;
    ...
    mL_DirCommentConstructor: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:209:2: ({...}? => '<!--' ( options {greedy=false; } : ( . )* ) '-->' )
            // XMLLexer.g:209:4: {...}? => '<!--' ( options {greedy=false; } : ( . )* ) '-->'
            if ( !(( !this.inElem )) ) {
                throw new org.antlr.runtime.FailedPredicateException(this.input, "L_DirCommentConstructor", " !this.inElem ");
            }
            this.match("<!--"); 

            // XMLLexer.g:209:32: ( options {greedy=false; } : ( . )* )
            // XMLLexer.g:209:59: ( . )*
            // XMLLexer.g:209:59: ( . )*
            loop11:
            do {
    ...
    mL_DirPIConstructor: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // XMLLexer.g:212:2: ({...}? => '<?' ( SU )? NCNameUnprotected ( SU ( options {greedy=false; } : ( . )* ) )? '?>' )
            // XMLLexer.g:212:4: {...}? => '<?' ( SU )? NCNameUnprotected ( SU ( options {greedy=false; } : ( . )* ) )? '?>'
            if ( !(( !this.inElem )) ) {
            ...
            this.mNCNameUnprotected(); 
            // XMLLexer.g:213:30: ( SU ( options {greedy=false; } : ( . )* ) )?
            var alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // XMLLexer.g:213:31: SU ( options {greedy=false; } : ( . )* )
                    this.mSU(); 
                    // XMLLexer.g:213:34: ( options {greedy=false; } : ( . )* )
                    // XMLLexer.g:213:61: ( . )*
                    // XMLLexer.g:213:61: ( . )*
                    loop13:
                    do {
