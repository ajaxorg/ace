...
(function(){
    ...
    this.setShowGutter = function(showGutter) {
        this.rendere.setShowGutter(showGutter);
    }

    this.getHScrollBarAlwaysVisible = function() {
        return this.renderer.getHScrollBarAlwaysVisible();
    }

    this.setHScrollBarAlwaysVisible = function(alwaysVisible) {
        this.renderer.setHScrollBarAlwaysVisible(alwaysVisible);
    }
    ...
    this.removeRight = function() {
        if (this.session.session.getReadOnly())
            return;
