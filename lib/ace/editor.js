...
(function(){
    ...
    this.insert = function(text) {
        ...
        var cursor = this.getCursorPosition();
        var transform = mode.transformInput(session.getState(cursor.row), this, session, text);
    ...
    this.removeLeft = function() {
        ...
        var state = session.getState(selection.start.row);
        var range = session.getMode().transformRemove(state, this, session, selection);
