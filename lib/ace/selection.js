...
(function() {
    ...
    * - keepDesiredColumn (Boolean): [If `true`, the cursor move does not respect the previous column]{: #keepDesiredColumn}
    *
    ...
    * - row (Number): The row to move to
    * - column (Number): The column to move to
    * - keepDesiredColumn (Boolean): {:keepDesiredColumn}
    *
    * Moves the cursor to the screen position indicated by row and column. {:keepDesiredColumn}
    **/
