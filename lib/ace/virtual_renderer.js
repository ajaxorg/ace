...
(function() {
    ...
    **/
    ...
    this.$moveTextAreaToCursor = function() {
        ...
        if (posLeft > this.$size.scrollerWidth - this.characterWidth)
            posLeft = this.$size.scrollerWidth - this.characterWidth;

        if (this.showGutter)
            posLeft += this.$gutterLayer.gutterWidth;

        this.textarea.style.height = this.lineHeight + "px";
        this.textarea.style.width = this.characterWidth + "px";
