...
(function() {
    ...
    this.scrollByPercent = function(percentY) {
    	var mod = 1 - (this.layerConfig.lastRow-this.layerConfig.firstRow)/this.session.getScreenLength()
    	this.scrollToY(Math.round(percentY * this.session.getScreenLength() * this.lineHeight * mod))
    };
