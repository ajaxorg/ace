...
WindowViewMock.prototype.getMouseEventTarget = function() {
    return this.container;
};

WindowViewMock.prototype.getTextAreaContainer = function() {
    return this.container;
};
...
WindowViewMock.prototype.setSession = function(session) {
    this.session = session;
};

WindowViewMock.prototype.getSession = function(session) {
    return this.session;
};
