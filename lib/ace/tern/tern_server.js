...
define(function (require, exports, module) {
    ...
    var aceCommands = {
        ...
        ternRefresh: {
            name: "ternRefresh",
            exec: function (editor) {
                //if user presses twice in less than 1 second, then do a full refresh (removes all docs and reloads including refs)
                var full = false;
    ...
    TernServer.prototype = {
         ...
         * @param {bool} full - pass true to remove all docs from server and reload including refs
         */
         ...
         * Note: can call this to force reload of explicit vs refs (using ///<reference path=""/>)
         */
    ...
    function findRefs(ts, editor, cb) {
        ...
        ts.request(editor, {
            ...
            var finalizeRefInput = function () {
                ...
                //bind escape key press while in the list to close it
    ...
    function moveTo(ts, curDoc, doc, start, end, doNotCloseTips) {
        ...
        //still going: current doc, so go to posistion
    ...
    function trackChange(ts, doc, change) {
        ...
        //note: not sure if this works in all cases. old version of ace had different property when changing 1 line vs multiple
        _change.text = change.lines;
        /* code below is for old version of ace
    ...
    function loadExplicitVsRefs(ts, editor) {
        ...
        //#region callbacks after each file is added, once all are done this shows message via tooltip
