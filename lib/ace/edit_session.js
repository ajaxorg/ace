    ...
    this.$updateInternalDataOnChange = function(e) {
        ...
        if (len != 0) {
            if (action.indexOf("remove") != -1) {
                ...
                if (this.$breakpoints.last > firstRow) {
                    this.$breakpoints.last -= len;
                    this.$breakpoints.splice(firstRow + 1, len);
                    this._delayedDispatchEvent("changeBreakpoint", {src: 'document.onChange'}, 200);
                }
