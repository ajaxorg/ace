...
class Folding {
    ...
    // structured folding
Folding.prototype.$foldStyles = {
    "manual": 1,
    "markbegin": 1,
    "markbeginend": 1
};
Folding.prototype.$foldStyle = "markbegin";

Folding.call = function(target) {
    Object.getOwnPropertyNames(Folding.prototype).forEach(function(key) {
        if (!target[key])
            target[key] = Folding.prototype[key]; 
    });
};
