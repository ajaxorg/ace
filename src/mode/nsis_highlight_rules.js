...
var NSISHighlightRules = function () {
    ...
    this.$rules = {
        start: [{
            ...
            regex: /^\s*!(?:include|addincludedir|addplugindir|appendfile|appendmemfile|assert|cd|delfile|echo|error|execute|packhdr|pragma|finalize|getdllversion|gettlbversion|system|tempfile|warning|verbose|define|undef|insertmacro|macroundef|makensis|searchparse|searchreplace|uninstfinalize)\b/,
            ...
            regex: /^\s*!(?:ifdef|ifndef|if|ifmacrodef|ifmacrondef|elseifdef|elseifndef|elseifmacrodef|elseifmacrondef|elseif|else|endif|macro|macroend)\b/,
            caseInsensitive: true
        }, {
            ...
            regex: /(?:\b|^\s*)(?:(?:un\.)?components|(?:un\.)?custom|(?:un\.)?directory|(?:un\.)?instfiles|(?:un\.)?license|uninstConfirm|admin|all|amd64-unicode|auto|both|bottom|bzip2|colored|current|force|hide|highest|ifdiff|ifnewer|lastused|leave|left|listonly|lzma|nevershow|none|normal|notset|open|print|right|show|silent|silentlog|smooth|textonly|top|try|user|Win10|Win7|Win8|WinVista|x86-(ansi|unicode)|zlib)\b/,
            caseInsensitive: true
        }, {
