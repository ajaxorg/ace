...
var MysqlHighlightRules = function() {
    ...
    var mathFunctions = 'abs|acos|asin|atan|atan|ceil|ceiling|conv|cos|cot|crc|degrees|div|exp|floor|ln|log|log|log|mod|pi|pow|power|radians|rand|round|sign|sin|sqrt|tan|truncate';
