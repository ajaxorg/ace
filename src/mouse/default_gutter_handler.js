...
function GutterHandler(mouseHandler) {
    ...
    function showTooltip() {
        ...
        var iconClass = gutter.useSvgGutterIcons ? "ace_icon_svg" : "ace_icon";

        // Construct the body of the tooltip.
        for (var i = 0; i < annotation.text.length; i++) {
            var line = `<span class='ace_${annotation.type[i]} ${iconClass}' aria-label='${annotationLabels[annotation.type[i]].singular}' role=img> </span> ${annotation.text[i]}`;
