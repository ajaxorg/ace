...
class BaseDiffView {
    ...
    initSelectionMarkers() {
        ...
        this.sessionA.addDynamicMarker(this.syncSelectionMarkerA, !this.inlineDiffEditor);
        this.sessionB.addDynamicMarker(this.syncSelectionMarkerB, !this.inlineDiffEditor);
    }
